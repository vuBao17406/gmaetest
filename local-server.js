...
function tryKeywordMatch(clientPayload) {
  ...
  switch (station) {
    case 1: {
      ...
      if (isPaperOrPuzzle) {
        responseText = "🤖 LOTUS-X gợi ý: Những kí tự rời rạc trên trang giấy phẳng lặng ấy chưa thể tự cất lời đâu... Hãy thử tìm một vật thể hình trụ tròn quen thuộc luôn đồng hành trong ba lô của bạn – như một chai nước chẳng hạn – rồi để mảnh giấy ôm trọn lấy thân nó xem điều bất ngờ gì sẽ xuất hiện! 🌀💧";
